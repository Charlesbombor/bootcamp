...
public class Book {
  ...
  public static void main(String[] args) {
    ...
    //System.out.println(books.contains(new Book("ABC"))); // false, before ovveriding the equals() method
    System.out.println(books.contains(book)); // true, after overriding the equals() method
